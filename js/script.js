...
(function () {
  ...
  const MENU = [
    {
      group: "Signature Cocktails", key: "signature", note: "600 each",
      items: [
        ["Cloud Nine Aviation", "Gin, crème de violette, maraschino, lemon", 600],
        ["270° Special G&T", "Gin, kiwi, cucumber, basil leaves, tonic", 650],
        ["Berry Botanic Fizz", "Peach schnapps, lime, crushed berries, tonic", 600],
        ["270° Vegan Whiskey Sour", "Whiskey, aquafaba, sweet & sour, angostura", 650],
        ["Paloma Mezcolita", "Mezcal, grapefruit, cordial, lime, sparkling", 650],
        ["Golden Spark", "Rum, turmeric-infused honey, lime, ginger soda", 600],
        ["El Franco Spicy Margarita", "Tequila, grapefruit, watermelon, mint, jalapeño", 700],
        ["Tiki Don Colada", "Dark rum, lychee juice, coconut cream, blue curaçao", 700],
        ["270° Bourbon Fashioned", "Bourbon, smoked cinnamon aroma, angostura", 750],
        ["Kentucky Mint Julep", "Bourbon, fresh mint extract, sweet & sour", 650],
        ["270° Sunset", "House signature — ask your server", 650],
        ["Berlin Herbal Mule", "Vodka, rosemary ginger-infused honey", 600],
        ["Peachy Limoncello Spritz", "Prosecco, peach purée, limoncello, sparkling", 700],
      ],
    },
    {
      group: "Sips", key: "sips",
      items: [
        ["Mimosa", "Prosecco, fresh orange juice", 550],
        ["Sweet Dreams", "KWV brandy, crème de cassis, chocolate sauce", 600],
        ["Nairobi Nightcap", "Vodka, Kahlúa coffee liqueur, Baileys, whipped cream", 650],
      ],
    },
    {
      group: "Mocktails", key: "mocktail",
      items: [
        ["Arnold Palmer Iced Tea", "Iced tea, lemonade", 400],
        ["270° Lahori Apple Mint", "Apple, mint, spiced soda", 500],
        ["Virgin Mojito", "Lime, mint, soda", 400],
        ["Berry Bliss", "Mixed berries, lime, soda", 400],
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ["Fresh Juice: Orange | Passion Fruit", "", 350],
        ["Tropical Mix | Pineapple", "", 400],
        ["Signature Smoothie: Mango Banana", "", 400],
        ["Pineapple Coconut | Tropical Green", "", 400],
        ["Matcha", "", 400],
      ],
    },
    {
      group: "Soft Drinks &amp; Water", key: "soft",
      items: [
        ["Still Water (750ml)", "", 250],
        ["Still Water (1L)", "", 300],
        ["Sparkling Water (750ml)", "", 350],
        ["Stoney Tangawizi", "", 250],
        ["Coca-Cola / Coca-Cola Zero", "", 250],
        ["Sprite / Fanta / Tonic", "", 250],
      ],
    },
    {
      group: "Food &amp; Small Plates", key: "food",
      items: [
        ["Enchiladas", "Slow-braised filling, roasted salsa, crema, micro herbs", 1450],
        ["French Toast", "Brioche, granola crumble, strawberries, cream", 950],
        ["Avocado & Smoked Salmon Toast", "Sourdough, avocado, smoked salmon, radish", 1300],
        ["Loaded Rooftop Fries", "Truffle aioli, parmesan, herbs", 750],
        ["Sharing Platter", "Chef's selection for the table", 2800],
        ["Cappuccino", "Locally roasted, latte art included", 350],
      ],
    },
  ];
  ...
  const GALLERY = [
    ...
    { label: "Signature Spicy Margarita", icon: "🍹", grad: "linear-gradient(135deg,#ff8a5c,#ffb36b)" },
    { label: "Open-Air Lounge Seating", icon: "🛋️", grad: "linear-gradient(160deg,#2b3a55,#141d2f)" },
    { label: "Enchiladas", icon: "🌯", grad: "linear-gradient(135deg,#f5c451,#ff8a5c)" },
    { label: "City Lights at Night", icon: "🌃", grad: "linear-gradient(160deg,#141a2b,#3a2f57)" },
    { label: "French Toast Brunch", icon: "🍓", grad: "linear-gradient(135deg,#ff9fb0,#ffc15c)" },
    { label: "Latte Art Cappuccino", icon: "☕", grad: "linear-gradient(135deg,#8a5a3c,#c99a6c)" },
